...
This repo was bootstrapped for `kontourai.io` with a conservative starter kit for agent-guided development.
...
- Repo kind: `application`
- Evidence Check: `npm run validate && npm run test:rendered`
